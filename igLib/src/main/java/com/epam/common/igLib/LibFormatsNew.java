...
public final class LibFormatsNew {
     ...
     */
    private static StringBuilder convertLongToStringBuilderDMark(long in, String decimalMark, boolean addSpaces) {
