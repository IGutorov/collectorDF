...
final class PackageConsts {
    ...
    static final String PARAM_REST = "Rest";    // Всех остатки НА дату (end of date сверка)
    ...
    static byte negativeCharType(final byte in) {
        switch (in) {
            case TURN_CHARTYPE_DEBET: return TURN_CHARTYPE_CREDIT;
            case TURN_CHARTYPE_CREDIT: return TURN_CHARTYPE_DEBET;
            default: return TURN_CHARTYPE_NOT_DEFINED;
        }
    } 
    ...
    static boolean onlyGL(final int diffType) {
    ...
    static final ClassField[] TURN_FIELDS = new ClassField[] { new ClassField("rowNumber     ", Integer.class),
            new ClassField("diffType         ", String.class), new ClassField("resourceNumber ", String.class),
            new ClassField("turnCharType     ", String.class), new ClassField("externalID     ", String.class),
            new ClassField("turnAmount     ", Money100.class), new ClassField("docNumber      ", String.class),
            new ClassField("docID            ", String.class), new ClassField("deltaAmount  ", Money100.class),
            new ClassField("detailMesssage   ", String.class), new ClassField("batchBrief     ", String.class),
            new ClassField("debResNumber     ", String.class), new ClassField("creResNumber   ", String.class) };

    static final ClassField[] REST_FIELDS = new ClassField[] { new ClassField("rowNumber     ", Integer.class),
            new ClassField("diffType         ", String.class), new ClassField("resourceNumber ", String.class),
            new ClassField("restGL         ", Money100.class), new ClassField("restMaster   ", Money100.class),
            new ClassField("deltaRest      ", Money100.class) };

    static final ClassField[] DOCS_FIELDS = new ClassField[] { new ClassField("rowNumber     ", Integer.class),
            new ClassField("diffType         ", String.class), new ClassField("resourceNumber ", String.class),
            new ClassField("externalID       ", String.class), new ClassField("docAmount    ", Money100.class),
            new ClassField("docNumber        ", String.class), new ClassField("docID          ", String.class),
            new ClassField("deltaAmountDoc ", Money100.class), new ClassField("detailMesssage ", String.class) };

    static final ClassField[] SUMM_FIELDS = new ClassField[] { new ClassField("mainCriterion  ", String.class),
            new ClassField("secondCriterion  ", String.class), new ClassField("leftCount     ", Integer.class),
            new ClassField("leftAmount     ", Money100.class), new ClassField("rightCount    ", Integer.class),
            new ClassField("rightAmount    ", Money100.class), new ClassField("notEqualsCount", Integer.class),
            new ClassField("deltaAmount    ", Money100.class) };
